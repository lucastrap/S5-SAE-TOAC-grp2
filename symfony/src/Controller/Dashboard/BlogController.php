...
{
    #[Route('/', name: 'app_dashboard_blog_index', methods: ['GET'])]
    ...
    #[Route('/new', name: 'app_dashboard_blog_new', methods: ['GET', 'POST'])]
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('app_dashboard_blog_index', [], Response::HTTP_SEE_OTHER);
        }
    ...
    #[Route('/{id}', name: 'app_dashboard_blog_delete', methods: ['POST'])]
